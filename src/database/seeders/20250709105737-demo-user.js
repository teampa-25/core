...
module.exports = {
  ...
  up: async (qi) => {
    ...
    await module.exports.secure_add(
      qi,
      "admin@infernode.example.org",
      admin_password,
      "admin",
      100000,
    );
